...
public class TestExample5File extends TestCase {

	public void testOne() throws Exception {
		PushBackLineReader in = new PushBackLineReader(new BufferedReader(new FileReader("tests/example5.ldif")), false);
